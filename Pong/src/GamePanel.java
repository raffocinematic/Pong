...
public class GamePanel extends JPanel implements Runnable {
	//dichiaro final e static per convenzione: static perchè se avessi più istanze del game panel condivideranno una unica variabile che è
	//final perchè fissa e immodificabile
	...
	public void move() {
		//per rendere il movimento più fluido
		paddle1.move();
		paddle2.move();
		ball.move();
	...
	public void checkCollision() {
		...
		//ereditiamo il metodo intersects da rectangle dato che ball è sottoclasse di rectangle
		...
		//ferma le racchette ai bordi del campo, così non escono dallo schermo
		if (paddle1.y<=0)
			paddle1.y=0;
